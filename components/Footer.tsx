  ...
  return (
    <footer className="border-t border-gray-200 dark:border-gray-800 mt-16">
      <div className="container pt-10 pb-6">
        <NewsletterForm className="max-w-md mx-auto mb-10" />
      </div>
      <div className="container pb-10 text-sm text-gray-500 flex items-center justify-between flex-col md:flex-row gap-4 md:gap-0">
        ...
        <div className="flex items-center gap-2">
          ...
          <span>•</span>
          <Link href="https://x.com/themohsenme" target="_blank" className="hover:underline">
            X
          </Link>
          <span>•</span>
