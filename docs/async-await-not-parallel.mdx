---
title: "Why async/await Doesn’t Make JavaScript Code Parallel"
summary: "Async/await feels like parallel code, but it isn’t. Here’s why JavaScript is still single-threaded and how async really works."
...
<ParallelFlow tracks="fetch /a|fetch /b|fetch /c" label="Sequential — each waits for the previous" color="orange" />
...
<ParallelFlow tracks="fetch /a|fetch /b|fetch /c" merge="await Promise.all" label="Concurrent — all start at once" color="green" />
