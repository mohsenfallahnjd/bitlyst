  ...
  return (
    <section className="space-y-8">
      <div className="space-y-2">
        <h1 className="text-2xl font-semibold tracking-tight">Bite-sized tech tips.</h1>
        <p className="text-gray-600 dark:text-gray-300">Clear, minimal explanations you can read in minutes.</p>
      </div>
